(function (app) {
    ...
    app.controller('appRoleCtrl', appRoleCtrl);

    appRoleCtrl.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox'];

    function appRoleCtrl($scope, apiService, notificationService, $ngBootbox) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 0;
        $scope.pageCount = 0;
