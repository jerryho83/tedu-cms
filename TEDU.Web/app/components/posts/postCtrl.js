(function (app) {
    ...
    postCtrl.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox'];

    function postCtrl($scope, apiService, notificationService, $ngBootbox) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 0;
        $scope.pageCount = 0;
        ...
        function search(page) {
            ...
            apiService.get('/api/post/getlistpaging', config, dataLoadCompleted, dataLoadFailed);
        }
