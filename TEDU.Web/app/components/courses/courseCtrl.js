(function (app) {
    ...
    courseCtrl.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox'];

    function courseCtrl($scope, apiService, notificationService, $ngBootbox) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 0;
        $scope.pageCount = 0;
        ...
        function search(page) {
            ...
            apiService.get('/api/course/getlistpaging', config, dataLoadCompleted, dataLoadFailed);
        }
